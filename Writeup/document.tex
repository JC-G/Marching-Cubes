...
\begin{itemize}
  ...
  \item Use the lookup tables to determine how much geometry exists within this transition cell, and increase the atomic counter accordingly, similarly to listing \ref{tv_count_regular}.
